...
KAR::ModManager::ModManager(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &position,
                           const wxSize &size, long style)
    : wxDialog(parent, id, title, position, size, style)
{
	wxGenericStaticBitmap *const sbDolphinLogo =
	    new wxGenericStaticBitmap(this, wxID_ANY, WxUtils::LoadScaledResourceBitmap("dolphin_logo", this));

	const wxString DolphinText = _("Warp Star - Ishiiruka");
	const wxString RevisionText = scm_desc_str;
	const wxString CopyrightText = _("(c) 04/23/2024+ Sean (Jas) Mott. \"GameCube\", \"Wii\", and \"Kirby Air Ride\" "
	                                 "are trademarks of Nintendo. Warp Star "
	...
	const wxString Text =
	    _("\n"
	      ...
	      "Special thanks to Jinxy for assisting with finding some of the quirks with Dolphin and being a second pair "
	      "of eyes to this insane idea\n\n"
	...
	wxHyperlinkCtrl *const License =
	    new wxHyperlinkCtrl(this, wxID_ANY, LicenseText, "https://github.com/SeanMott/WarpStar/blob/main/license.txt");
	...
	wxHyperlinkCtrl *const Support = new wxHyperlinkCtrl(this, wxID_ANY, SupportText, "http://discord.gg/p3rGrcr");
